...
// a byte payload we can size up or down to stress serialization.
...
var file_echo_proto_goTypes = []any{
	(*EchoRequest)(nil),  // 0: echobench.EchoRequest
	(*EchoResponse)(nil), // 1: echobench.EchoResponse
}
