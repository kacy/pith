...
fn resolve_func_name(name: &str) -> &str {
    match name {
        ...
        "list_remove" => "forge_list_remove_value",
        "list_is_empty" => "forge_list_is_empty",
        "list_clear" => "forge_list_clear_value",
        "list_reverse" => "forge_list_reverse_value",
        "set_contains" => "forge_set_contains_cstr",
        "map_contains_key" => "forge_map_contains_cstr",
        ...
        "string_index_of" => "forge_cstring_index_of",
        "string_last_index_of" => "forge_cstring_last_index_of",
        "string_is_empty" => "forge_cstring_is_empty",
        "contains_key" => "forge_map_contains_cstr",
        "keys" => "forge_map_keys_cstr",
        "remove" => "forge_list_remove_value",
        "is_empty" => "forge_list_is_empty",
        "clear" => "forge_list_clear_value",
