...
run-examples-self: self-host
	...
	for name in stdlib_new file_io iteration operators fs_ops time_rand tcp_echo channels process_ops arc_string_stress arc_scope_test arc_closure_stress arc_cycle_test; do \
